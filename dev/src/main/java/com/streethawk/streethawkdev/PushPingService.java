...
public class PushPingService extends Service implements ISHObserver {
    ...
    private final int DURATION_PING_CHECK = 1000 * 60 * 5;  //10 minutes
                ...
                try {
                    ...
                    try {
                        ...
                        if (diff > 600) {
                            ...
                            String message = "Android Didnt received push for last "+minutes;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    params.put("token", "xoxp-2189686668-19803167138-40995974385-c58743c259");
                    params.put("channel", "#prod_bugs");
