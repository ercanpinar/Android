...
public class GeofenceData {
    ...
    public GeofenceData setLatitude(double latitude){this.mLatitude=latitude;return this;}
    public GeofenceData setLongitude(double longitude){this.mLongitude=longitude;return this;}
