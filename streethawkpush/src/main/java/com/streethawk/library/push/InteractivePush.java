...
public class InteractivePush implements Constants {
     ...
     * @param title
     */
    public void setPairTitle(String title) {
        this.mPairTitle = title;
    }
     ...
     * @param B1Icon
     */
    public void setB1Icon(int B1Icon) {
        this.mB1Icon = B1Icon;
    }
     ...
     * @param B2Icon
     */
    public void setB2Icon(int B2Icon) {
        this.mB2Icon = B2Icon;
    }
     ...
     * @param B3Icon
     */
    public void setB3Icon(int B3Icon) {
        this.mB3Icon = B3Icon;
    }
