...
public class NotificationBase implements Constants{
    ...
    public static final int TYPE_SIMPLE_OKAY = TYPE_BT_ENABLE_TOAST + 1;
        ...
        if (action == STREETHAWK_ACCEPTED) {
            switch (code) {
                ...
                case CODE_USER_LOGIN_SCREEN:
                    return (context.getResources().getIdentifier(ICON_APPPAGE, "drawable", packageName));      //8004
                case CODE_RATE_APP:
                    return (context.getResources().getIdentifier(ICON_RATE, "drawable", packageName));         //8005
                case CODE_UPDATE_APP:
                    return (context.getResources().getIdentifier(ICON_UPDATE, "drawable", packageName));         //8008
                case CODE_CALL_TELEPHONE_NUMBER:
                    return (context.getResources().getIdentifier(ICON_TELEPHONE, "drawable", packageName));     //8009
                case CODE_SIMPLE_PROMPT:
                    return (context.getResources().getIdentifier(ICON_SIMPLEPUSH, "drawable", packageName));   //8010
                case CODE_FEEDBACK:
                    return (context.getResources().getIdentifier(ICON_FEEDBACK, "drawable", packageName));     //8011
                case CODE_IBEACON:
                    return (context.getResources().getIdentifier(ICON_BLEUTOOTH, "drawable", packageName));    //8012
                case CODE_ACCEPT_PUSHMSG:
                    return (context.getResources().getIdentifier(ICON_ACCEPT_PUSH, "drawable", packageName));  //8013
                case CODE_ENABLE_LOCATION:
                    return (context.getResources().getIdentifier(ICON_ENABLE_LOC, "drawable", packageName));   //8014
        ...
        if (action == STREETHAWK_DECLINED) {
            switch (code) {
                ...
                case CODE_CUSTOM_ACTIONS:
                    return 0;
                default:
                    // rest all cases other than rate
                    return (context.getResources().getIdentifier(ICON_CANCEL, "drawable", packageName));
            }
        }
        return 0;
    }
    ...
    /**
     * Replace shortnames to unicode characters. Emoji one
     */
    protected String getUnicodeForEmoji(String input, boolean removeIfUnsupported) {
        if (null == input)
            return null;
    ...
    protected static String getStringtoDisplay(Context context, int String_type) {
        ...
        int id = 0;
        switch (String_type) {
            case TYPE_SHOW_URL_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_SHOW_URL_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_SHOW_URL_POSITIVE;    // fall back string
                break;
            case TYPE_SHOW_URL_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_SHOW_URL_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_SHOW_URL_NEGATIVE;
                break;
            case TYPE_SHOW_URL_CLOSE:
                id = context.getResources().getIdentifier("STREETHAWK_SHOW_URL_CLOSE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_SHOW_URL_CLOSE;
                break;
            case TYPE_OPEN_APP_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_OPEN_APP_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_OPEN_APP_POSITIVE;
                break;
            case TYPE_OPEN_APP_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_OPEN_APP_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_OPEN_APP_NEGATIVE;
                break;
            case TYPE_RATE_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_RATE_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_RATE_POSITIVE;
                break;
            case TYPE_RATE_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_RATE_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_RATE_NEGATIVE;
                break;
            case TYPE_UPDATE_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_UPDATE_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_UPDATE_POSITIVE;
                break;
            case TYPE_UPDATE_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_UPDATE_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_UPDATE_NEGATIVE;
                break;
            case TYPE_CALL_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_CALL_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_CALL_POSITIVE;
                break;
            case TYPE_CALL_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_CALL_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_CALL_NEGATIVE;
                break;
            case TYPE_SIMPLE_PUSH_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_SIMPLE_MESSAGE_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_SIMPLE_MESSAGE_POSITIVE;
                break;
            ...
            case TYPE_SIMPLE_PUSH_NOTIFICATION_POSITIVE:
                ...
                break;
            case TYPE_PUSH_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_PUSH_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_PUSH_POSITIVE;     //Enable
                break;
            case TYPE_PUSH_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_PUSH_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_PUSH_NEGATIVE;     //Cancel
                break;
            case TYPE_LOCATION_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_LOCATION_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_LOCATION_POSITIVE;
                break;
            case TYPE_LOCATION_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_LOCATION_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_LOCATION_NEGATIVE;
                break;
            case TYPE_BLUETOOTH_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_BLUETOOTH_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_BLUETOOTH_POSITIVE;
                break;
            case TYPE_BLUETOOTH_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_BLUETOOTH_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_BLUETOOTH_NEGATIVE;
                break;
            case TYPE_FEEDBACK_POSITIVE:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_POSITIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_POSITIVE;
                break;
            case TYPE_FEEDBACK_NEGATIVE:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_NEGATIVE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_NEGATIVE;
                break;
            case TYPE_FEEDBACK_SUBMIT:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_SUBMIT", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_SUBMIT;
                break;
            case TYPE_FEEDBACK_CANCEL:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_CANCEL", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_CANCEL;
                break;
            case TYPE_FEEDBACK_HINT_TITLE:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_HINT_TITLE", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_HINT_TITLE;
                break;
            case TYPE_FEEDBACK_HINT_CONTENT:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_HINT_CONTENT", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_HINT_CONTENT;
                break;
            case TYPE_FEEDBACK_TOAST_SUCCESS:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_TOAST_SUCCESS", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_TOAST_SUCCESS;
                break;
            case TYPE_FEEDBACK_TOAST_ERROR:
                id = context.getResources().getIdentifier("STREETHAWK_FEEDBACK_TOAST_ERROR", "string", packageName);
                if (0 == id)
                    return STREETHAWK_FEEDBACK_TOAST_ERROR;
                break;
            case TYPE_BT_ENABLE_TOAST:
                id = context.getResources().getIdentifier("BLUETOOTH_ENABLE_TOAST", "string", packageName);
                if (0 == id)
                    return BLUETOOTH_ENABLE_TOAST;
                break;
            case TYPE_SIMPLE_OKAY:
                id = context.getResources().getIdentifier("STREETHAWK_SIMPLE_OK", "string", packageName);
                if (0 == id)
                    return BLUETOOTH_ENABLE_TOAST;
                break;
            case TYPE_SIMPLE_CANCEL:
                id = context.getResources().getIdentifier("STREETHAWK_SIMPLE_CANCEL", "string", packageName);
                if (0 == id)
                    return BLUETOOTH_ENABLE_TOAST;
                break;
            default:
    ...
    protected String getNegativeButtonTitle(Context context, int code) {
        switch (code) {
            case CODE_OPEN_URL:
                return getStringtoDisplay(context, TYPE_SHOW_URL_NEGATIVE);
            case CODE_LAUNCH_ACTIVITY:
            case CODE_USER_REGISTRATION_SCREEN:
            case CODE_USER_LOGIN_SCREEN:
                return getStringtoDisplay(context, TYPE_OPEN_APP_NEGATIVE);
            case CODE_RATE_APP:
                return getStringtoDisplay(context, TYPE_RATE_NEGATIVE);
            case CODE_UPDATE_APP:
                return getStringtoDisplay(context, TYPE_UPDATE_NEGATIVE);
            case CODE_CALL_TELEPHONE_NUMBER:
                return getStringtoDisplay(context, TYPE_CALL_NEGATIVE);
            case CODE_FEEDBACK:
                return getStringtoDisplay(context, TYPE_FEEDBACK_NEGATIVE);
            case CODE_IBEACON:
                return getStringtoDisplay(context, TYPE_BLUETOOTH_NEGATIVE);
            case CODE_ACCEPT_PUSHMSG:
                return getStringtoDisplay(context, TYPE_PUSH_NEGATIVE);
            case CODE_ENABLE_LOCATION:
                return getStringtoDisplay(context, TYPE_LOCATION_NEGATIVE);
            case CODE_CUSTOM_ACTIONS:
                return getStringtoDisplay(context, TYPE_SIMPLE_CANCEL);  // incase buttton pairs is not available
            default:
                return getStringtoDisplay(context, TYPE_DEFAULT_NEGATIVE);
        }


    }

    protected String getPositiveButtonTitle(Context context, int code) {
        switch (code) {
            case CODE_OPEN_URL:
                return getStringtoDisplay(context, TYPE_SHOW_URL_POSITIVE);
            case CODE_LAUNCH_ACTIVITY:
            case CODE_USER_REGISTRATION_SCREEN:
            case CODE_USER_LOGIN_SCREEN:
                return getStringtoDisplay(context, TYPE_OPEN_APP_POSITIVE);
            case CODE_RATE_APP:
                return getStringtoDisplay(context, TYPE_RATE_POSITIVE);
            case CODE_UPDATE_APP:
                return getStringtoDisplay(context, TYPE_UPDATE_POSITIVE);
            case CODE_CALL_TELEPHONE_NUMBER:
                return getStringtoDisplay(context, TYPE_CALL_POSITIVE);
            case CODE_SIMPLE_PROMPT:
                return getStringtoDisplay(context, TYPE_SIMPLE_PUSH_POSITIVE);
            case CODE_FEEDBACK:
                return getStringtoDisplay(context, TYPE_FEEDBACK_POSITIVE);
            case CODE_IBEACON:
                return getStringtoDisplay(context, TYPE_BLUETOOTH_POSITIVE);
            case CODE_ACCEPT_PUSHMSG:
                return getStringtoDisplay(context, TYPE_PUSH_POSITIVE);
            case CODE_ENABLE_LOCATION:
                return getStringtoDisplay(context, TYPE_LOCATION_POSITIVE);
            case CODE_CUSTOM_ACTIONS:
                return getStringtoDisplay(context, TYPE_SIMPLE_OKAY);  // in case button pairs are not available
            default:
                return getStringtoDisplay(context, TYPE_DEFAULT_POSITIVE);
        }
